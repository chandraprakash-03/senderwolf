...
const mailSchema = z
    ...
    .refine((data) => data.html || data.text || data.amp || data.calendar !== undefined || data.react !== undefined || data.vue !== undefined, {
        message: "Either 'html', 'text', 'amp', 'calendar', 'react', or 'vue' must be provided in mail body.",
        path: ["html"],
    });
